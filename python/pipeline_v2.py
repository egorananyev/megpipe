...
home_path = '/mnt/d/' ## change this according to needs

Windows = False #Using windows?
...
project_name = 'analyses/omission_frontiers_BIDS-FieldTrip'
...
IgnoreList = [''] #Ignore selected subjects.
...
subjects_to_run = (0, 2) # subject indices to run, if you don't want to run all
...
operations_to_apply = dict(
                    ...
                    source_estimate=0,
                    morph_to_fsaverage=0, #operations_functions mne.morph_data set to njob = 1. Anything above = memory error.
                    ...
                    plot_ica=0,
                    plot_epochs_image=0,
                    plot_evokeds=0, #Not sure what this plot shows
